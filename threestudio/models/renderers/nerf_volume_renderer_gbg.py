...
class NeRFVolumeRenderer(VolumeRenderer):
    ...
    def forward(
        ...
        **kwargs
        ...
        # albedo = rgb_fg_all_dict['albedo']
        # rgb_fg_all = rgb_fg_all_dict['color']
        ...
        # comp_albedo_fg: Float[Tensor, "Nr Nc"] = nerfacc.accumulate_along_rays(
        #     weights[..., 0], values=albedo, ray_indices=ray_indices, n_rays=n_rays
        # )
        ...
        # comp_albedo = comp_albedo_fg + bg_color * (1.0 - opacity)
        ...
        out = {
            ...
            # "comp_albedo": comp_albedo.view(batch_size, height, width, -1),
            # "comp_albedo_fg": comp_albedo_fg.view(batch_size, height, width, -1),
        ...
        if self.training:
            ...
            if "normal" in geo_out:
                if self.cfg.return_comp_normal:
                    ...
                    comp_normal = comp_normal + bg_color * (1.0 - opacity)
                    out.update(
                        {
